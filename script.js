...
function verificarTabla(){
    ...
    if (bodyTablaEmpleados.innerHTML.trim() !== "") {
        ...
        botonConfirmar.className = 'boton-confirmar'; // Aplicar la clase de estilo 'boton-confirmar'
        ...
        bodyTablaEmpleados.innerHTML += `
            <tr>
                <td>
                    ...
                    <button class="boton-modificar" onclick="modificarPedido(${index})">Modificar</button>
                    <button class="boton-eliminar" onclick="eliminarPedido(${index})">Eliminar</button>
                </td>
            </tr>
            <tr>
                <th>Nombre:</th>
